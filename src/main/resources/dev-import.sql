INSERT INTO shipment (pro_number,display_pro,status,origin,destination,shipper,consignee,commodity,weight_lbs,pieces,pickup_time,driver_name,driver_phone,current_location,last_update,estimated_delivery) VALUES
